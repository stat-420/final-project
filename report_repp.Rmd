...
get_cv_log_rmse = function(model_formula, folds = 5) {
  total_rmse = 0
  for (i in 1:folds) {
    idx = sample(c(TRUE, FALSE), n, replace=TRUE, prob=c(0.75, 0.25))
    ...
    total_rmse = total_rmse + get_log_rmse(cv_set$SalePrice, cv_predicted)
  }
  total_rmse / folds
}
...
evaluate_model = function(model) {
  set.seed(42)
  data.frame(Log.RMSE = get_cv_log_rmse(model$terms), 
